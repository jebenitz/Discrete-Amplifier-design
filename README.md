...
**Stage Specifications:** A_d > 50, CMRR > 60 dB, consumption < 10 mA and simetric sources: V_CC = 12 V, V_EE = -12V.
...
# Circuit Diagram
<img src="schematics/DiffAmp-resload.png" width="500" alt="Compact view">

## Simulation Results
| Parameter | Value Obtained | Specification | Status |
|-----------|----------------|---------------|---------|
| A_d (Differential Gain) | 201.29 (46.07 dB) | > 50 | CORRECT |
| A_CM (Common-Mode Gain) | 2.84e-14 (-270.92 dB) | - | - |
| V_C (Collector Voltage) | 6.4 V | - | - |
| CMRR |  317.00 dB  | > 60 dB |  CORRECT|
...
Enhanced version of previous stage. Added an active load and emitter degeneration.
- Active load implemented using 2N2907 transistors.
# Circuit Diagram
